                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Edit Product: {{$data->name}}</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('products.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="name" id="validationProductName" value="{{$data->name}}"
                                        required>
                                </div>
                                <div class="col-md-6 mb-4">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label class="form-label" for="validationProductName">Created At</label>
                                    <input type="text" class="form-control" name="created_at" id="created_at" value="{{$data->created_at}}"
                                        disabled>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label class="form-label" for="validationProductName">Updated At</label>
                                    <input type="text" class="form-control" name="updated_at" id="updated_at" value="{{$data->updated_at}}"
                                        disabled>
                                </div>
                                <div class="col-md-12 mb-4">
