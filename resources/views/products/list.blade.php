                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <form id="deleteForm{{$value->id}}" action="{{ route('products.destroy', $value->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            <a href="#" onclick="confirmDelete(event, 'deleteForm{{$value->id}}')" class="d-flex align-items-center col-6">
