        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('point-shops.update', $data->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <label class="form-label" for="text">Name</label>
                                <input type="text" class="form-control" id="type" name="name" value="{{$data->name}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="text">Point</label>
                                <input type="text" class="form-control" id="type" name="point" value="{{$data->point}}">
                            </div>
                            <div class="form-group">
