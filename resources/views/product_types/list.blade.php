                        ...
                        @foreach ($product_type as $item)
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{route('product_types.edit', $item->id)}}" class="d-flex align-items-center mx-2 col-6">
                                            ...
                                            <form id="deleteForm{{$item->id}}" action="{{ route('product_types.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            <a href="#" onclick="confirmDelete(event, 'deleteForm{{$item->id}}')" class="d-flex align-items-center col-6">
