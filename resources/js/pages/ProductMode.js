...
const ProductMode = (props) => {
    ...
    return (
        <div className="w-6/12 flex-grow flex">
            <div className="flex flex-col bg-red-950 h-full w-full py-4">
                <div className="flex px-2 flex-row relative">
                    ...
                    <input onChange={(e) => setSearch(e.target.value)} type="text" className="bg-white rounded-3xl shadow text-lg full w-full h-16 py-4 pl-16 transition-shadow focus:shadow-2xl focus:outline-none" placeholder="search menu ..." />
                    </div>
                    ...
                    <div className="h-full overflow-y-auto px-2">
                        ...
                        { ( products.filter((data)=>{
                            ...
                            <div className="select-none bg-red-950 rounded-3xl flex flex-wrap content-center justify-center h-full opacity-25">
                                <div className="w-full text-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                    </svg>
                        ...
                        <div className="grid grid-cols-4 gap-4 pb-3">
                            { products.filter((data)=>{
                                ...
                                <div onClick={() => addToCart(item)} key={item.id} role="button" className="select-none cursor-pointer transition-shadow overflow-hidden rounded-2xl bg-dark shadow hover:shadow-lg" >
