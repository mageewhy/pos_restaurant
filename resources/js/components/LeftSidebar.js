...
const LeftSidebar = props => {
    ...
    return (
        <div className="w-30 bg-cyan-200 flex flex-row flex-shrink-0 pl-4 pr-2 py-4">
            <div className="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-cyan-500 rounded-3xl">
                <a href="#"
                className="flex items-center justify-center h-12 w-12 bg-red-900 text-cyan-700 rounded-full">
                ...
                <ul className="flex flex-col space-y-2 mt-12">
                    <li>
                        ...
                        <span className="flex items-center justify-center h-12 w-12 rounded-2xl bg-red-900 shadow-lg text-white">
